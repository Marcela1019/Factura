...
if(isset($_POST['editar'])){
  $data->setClienteNombre($_POST['clienteNombre']);
  $data->setCelular($_POST['celular']);
  $data->setCompañia($_POST['compañia']);
  
  $data->update();

  echo "<script> alert ('Datos Actualizados!!! ');document.location='clientes.php'</script>"; 
}
      ...
      <form class="col d-flex flex-wrap" action=""  method="post">
              <div class="mb-1 col-12">
                ...
                <input 
                  ...
                  name="clienteNombre"
                  class="form-control"  
                  value="<?php echo $value['clienteNombre']; ?>"
